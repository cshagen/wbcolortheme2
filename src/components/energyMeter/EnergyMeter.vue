    ...
    <figure id="energymeter" class="p-0 m-0">
      <svg viewBox="0 0 500 500">
        ...
        >
          ...
          ></EMBarGraph>
          <!-- Y Axis -->
          <EMYAxis :yScale="yScale" :width="width" :fontsize="axisFontsize" :config="globalConfig">
          </EMYAxis>
          <text :x="-margin.left" y="-15" fill="var(--color-axis)" :font-size="axisFontsize">kWh</text>
          <EMLabels
            :plotdata="plotdata"
            :xScale="xScale"
            :yScale="yScale"
