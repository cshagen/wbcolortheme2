      ...
      <div class="modal-content">
        ...
        <div class="modal-body" style="background-color: var(--color-bg);">
            ...
            <div class="row p-0 m-0">
              <div v-for="(bt, id) in buttons" :key="id" class="col-md-4 p-1">
                <div class="d-grid gap-2">
                  <button type="button" :class="buttonClass(bt.mode as ChargeMode)" :style="{}"
                  @click="selectChargeMode(bt.mode as ChargeMode)">{{ bt.name }}</button>
                </div>
              </div>
          ...
          <div class="modal-footer">
            <button type="button" class="btn btn-success buttonTextSize" data-bs-dismiss="modal">OK</button>
          </div>
        </div>
      </div>
    </div>
